...
import com.dicoding.picodiploma.loginwithanimation.customview.MyEmailEditText
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myEmailEditText = findViewById(R.id.emailEditText)
    }
    ...
    private fun showSuccessDialog() {
        AlertDialog.Builder(this).apply {
            setTitle("Yeah!")
            setMessage("Anda berhasil login. Sudah tidak sabar untuk membaca ya?")
